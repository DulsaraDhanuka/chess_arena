...
int main(int argc, char *argv[]) {
	...
	struct MemoryStruct out;
	out.memory = malloc(1);
	out.size = 1024*1024*100;
	...
	infstream.avail_in = (uInt)(chunk.size); // size of input
	infstream.next_in = (Bytef *)chunk.memory; // input char array
	infstream.avail_out = (uInt)out.size; // size of output
	infstream.next_out = (Bytef *)out.memory; // output char array
